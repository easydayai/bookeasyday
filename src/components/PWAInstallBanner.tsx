  ...
  return (
    <>
      ...
      <Dialog open={showIOSModal} onOpenChange={setShowIOSModal}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Install Rent EZ on iOS</DialogTitle>
            <DialogDescription className="space-y-4 text-left pt-4">
              <p>To install Rent EZ on your iPhone or iPad:</p>
              <ol className="list-decimal list-inside space-y-2 text-foreground">
                <li>Tap the <strong>Share</strong> button (square with arrow) at the bottom of Safari</li>
                <li>Scroll down and tap <strong>"Add to Home Screen"</strong></li>
                <li>Tap <strong>"Add"</strong> in the top right corner</li>
              </ol>
              <p className="text-muted-foreground text-sm">The Rent EZ app icon will appear on your home screen!</p>
            </DialogDescription>
          </DialogHeader>
