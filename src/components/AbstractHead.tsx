  ...
  return (
    <div className="w-full h-full overflow-hidden">
      <div className="relative w-full h-full flex items-center justify-center overflow-visible">
        ...
        <div 
          className="relative z-10 scale-[1.35] sm:scale-100 dark:[mask-image:radial-gradient(ellipse_90%_90%_at_center,black_20%,transparent_70%)] dark:[-webkit-mask-image:radial-gradient(ellipse_90%_90%_at_center,black_20%,transparent_70%)]"
        >
          <img
